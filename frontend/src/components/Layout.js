  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
        <div className="flex-1 flex flex-col min-h-0 bg-white/80 backdrop-blur-lg border-r border-gray-200/60">
              ...
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`${
                      isActive
                        ? 'bg-butterfly-50/70 border-butterfly-500 text-butterfly-700'
                        : 'border-transparent text-gray-600 hover:bg-gray-50/70 hover:text-gray-900'
      ...
      <div className="md:pl-64 flex flex-col flex-1">
        <div className="sticky top-0 z-10 md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3 bg-gray-50/80 backdrop-blur-lg">
